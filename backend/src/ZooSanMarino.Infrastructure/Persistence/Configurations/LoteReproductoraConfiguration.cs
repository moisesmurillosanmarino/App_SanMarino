// src/ZooSanMarino.Infrastructure/Persistence/Configurations/LoteReproductoraConfiguration.cs
  ...
  public void Configure(EntityTypeBuilder<LoteReproductora> e)
{
    ...
    e.Property(x => x.PesoInicialM).HasColumnName("peso_inicial_m");
    e.Property(x => x.PesoInicialH).HasColumnName("peso_inicial_h");
