// src/app/features/config/user-management/components/modal-registro-usuario/modal-registro-usuario.component.ts
...
export class ModalRegistroUsuarioComponent implements OnInit, OnDestroy {
  ...
  get modalTitle(): string {
    return this.isEditing ? 'Editar Usuario' : 'Registrar Usuario';
  }

  get submitButtonText(): string {
    return this.isEditing ? 'Actualizar' : 'Registrar';
  }
